...
export type MobileSettings = {
  ...
  media: {
    ...
    saveToGallery: { privateChats: boolean; groups: boolean; channels: boolean };
    callDataSaving: CallDataSaving;
  };
  proxy: { enabled: boolean; protocol: ProxyProtocol; host: string; port: number; username: string; password: string };
  energySaving: { enabled: boolean; threshold: number; stickers: boolean; emoji: boolean; chatAnimations: boolean; callAnimations: boolean; autoplayVideo: boolean; autoplayGif: boolean; particles: boolean; smoothTransitions: boolean };
