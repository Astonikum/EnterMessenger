...
export function isNewerVersion(version: string, currentVersion: string) {
...
export async function fetchLatestRelease(platform: "desktop" | "mobile", signal?: AbortSignal, cache?: "no-store"): Promise<PlatformRelease | null> {
